...
function compose_email(prefill=false) {
  ...
  if (prefill == true) {
    document.querySelector('#compose-recipients').value = document.querySelector('#to').innerHTML;
    document.querySelector('#compose-subject').value = document.querySelector('#subject').innerHTML;
    document.querySelector('#compose-body').value = document.querySelector('.mail-body__p').innerHTML;
  }
}
...
function view_mail(mail_id) {
  ...
  document.querySelector('#archieve').dataset.id = mail_id;
